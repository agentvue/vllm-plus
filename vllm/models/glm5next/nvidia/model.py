...
def _pad_shared_expert_weight_for_tp(
    name: str,
...
class Glm5NextModel(nn.Module, EagleModelMixin):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.config = config
        self._weight_block_size = getattr(
            vllm_config.quant_config, "weight_block_size", None
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        if get_pp_group().is_first_rank:
            ...
            if self.config.mhc:
                hidden_states = intermediate_tensors["residual"]
                residual = None
            else:
    ...
    def _pad_shared_expert_weight(
        ...
        return _pad_shared_expert_weight_for_tp(
            name, loaded_weight, self._weight_block_size
        )
