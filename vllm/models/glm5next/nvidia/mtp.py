...
from .model import (
    ...
    Glm5NextMoE,
    _pad_shared_expert_weight_for_tp,
...
class Glm5NextMTP(nn.Module, SupportsPP, DeepseekV2MixtureOfExperts):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self._weight_block_size = getattr(self.quant_config, "weight_block_size", None)
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        for name, loaded_weight in weights:
            ...
            loaded_weight = _pad_shared_expert_weight_for_tp(
